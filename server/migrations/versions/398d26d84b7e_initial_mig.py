...
Revision ID: 398d26d84b7e
Revises: 
Create Date: 2024-03-04 15:14:43.664883
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['venue_id'], ['venues.id'], name=op.f('fk_attendees_venue_id_venues')),
    sa.PrimaryKeyConstraint('user_id', 'venue_id', name=op.f('pk_attendees'))
    )
